...
categories:
  - DevOps
tags:
  - [Databricks, Monitoring, SystemTable, SQL, Dashboard, PredicatePushdown]
toc: true
toc_sticky: true
date: 2026-02-26
---
...
Databricks에서 장시간 돌아가는 Bitcoin ETL Job을 운영하다 보면 "어제 배치가 실패했는지, 소요 시간이 갑자기 늘었는지"를 빠르게 파악할 수 있는 모니터링 대시보드가 필수다.
