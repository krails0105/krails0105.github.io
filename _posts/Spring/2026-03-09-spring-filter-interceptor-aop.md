...
categories:
  - Spring
tags: [Java, Spring, Filter, Interceptor, AOP, RequestPipeline]
---
...
비유하면 Filter는 건물 입구 보안검색, Interceptor는 층별 안내데스크, AOP는 사무실 내부의 업무 보조와 같습니다. 바깥쪽일수록 HTTP에 가깝고, 안쪽일수록 비즈니스 로직에 가깝습니다.
